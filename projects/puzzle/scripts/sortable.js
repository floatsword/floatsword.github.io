...
(function (factory) {
	...
	var dragEl,
		...
		_dispatchEvent = function (rootEl, name, targetEl, fromEl, startIndex, newIndex) { //自定义事件触发器
		...
		_customEvents = 'onAdd onUpdate onRemove onStart onEnd onFilter onSort'.split(' '),   //创建用户自定义事件
